...
public class Main {
    ...
    public static int[] heroesHealth = {280, 270, 250, 330, 500, 250, 280, 250, };
    ...
    public static void lucky(){
       boolean randomBias = random.nextBoolean();
       if (randomBias){
           heroesHealth[5] += bossDamage;
       }
    }
    private static void thor() {
        boolean stanBoss = random.nextBoolean();
        if (heroesHealth[7] > 0 && stanBoss){
            bossDamage = 0;
        }
    }
